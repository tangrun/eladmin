...
public class PlanProject extends BaseEntity implements Serializable {
    ...
    @Column(name = "publish_review_remark")
    @ApiModelProperty(value = "发布审核备注说明")
    private String publishReviewRemark;

    public void copy(PlanProject source){
