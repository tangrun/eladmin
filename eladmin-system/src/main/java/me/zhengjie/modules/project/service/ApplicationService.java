...
public interface ApplicationService {
    ...
    */
    PageResult<ApplicationDto> queryAll(ApplicationQueryCriteria criteria, Pageable pageable);
    ...
    */
     ...
     */
    ApplicationDto findById(Long projectId);

    /**
    * 创建
    * @param resources /
    */
    void create(Application resources);
