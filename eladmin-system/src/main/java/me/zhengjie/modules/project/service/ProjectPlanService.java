...
public interface ProjectPlanService {
    ...
    */
    PageResult<ProjectPlanDto> queryAll(ProjectPlanQueryCriteria criteria, Pageable pageable);
    ...
    */
    List<ProjectPlanDto> queryAll(ProjectPlanQueryCriteria criteria);
     ...
     */
    ProjectPlanDto findById(Long planId);
    ...
    * @param resources /
    */
    void update(ProjectPlan resources);
    ...
    * @throws IOException /
    */
    void download(List<ProjectPlanDto> all, HttpServletResponse response) throws IOException;
}